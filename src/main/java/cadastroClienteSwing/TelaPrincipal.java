...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("MenuItemSair");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          ...
          Cliente cliente = new Cliente(nome, cpf, tel, num, cidade, estado, end);
    ...
    private void btnAttActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAttActionPerformed
        ...
        if(linhaSelecionada >= 0) {
            ...
            if(!isCamposValidos(nome, cpf.toString(), tel, end, num, cidade, estado)){
                JOptionPane.showMessageDialog(this, "Faltam preencher campos obrigatótios");
                return;
            }
